...
// NOTE: For my BST helper functions, I have appropriated the code given in our BST labs to suit my program. E.g. such as to create a tree, insert a node, print a tree, search a tree etc.
